...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
        <NavLink href="/Labs/Lab5" as={Link} className={`nav-link ${pathname.startsWith("Lab5") ? "active" : ""}`}>Lab 5</NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="/" as={Link}>Kambaz</NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://github.com/aravgoyal">My GitHub</NavLink>
     </NavItem>
   </Nav>
);}
